...
# We thought this would give us some insights into the optimization process
# It is designed to find the best genome (hyperparameters of the PSO) because they are hard to fine tune by hand
# The initial implementation was generated by ChatGPT and then modified by us to fit our needs
...
class AccelerationCoefficientsGenome:
    ...
    def mutate(self, mutation_rate: float, ranges: Dict[str, Tuple[float, float]]):
        """Mutate the genome by applying Gaussian noise to its parameters."""
    ...
    def crossover(
        ...
        Uses uniform crossover for all parameters."""
        out = {}
        for name in vars(a):
